...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HealthCheckFeatures) DeepCopyInto(out *HealthCheckFeatures) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HealthCheckFeatures.
func (in *HealthCheckFeatures) DeepCopy() *HealthCheckFeatures {
	if in == nil {
		return nil
	}
	out := new(HealthCheckFeatures)
	in.DeepCopyInto(out)
	return out
}
